...
class RAGPipeline:
    def __init__(self):
        ...
        self.retriever = None
        self.llm = ChatOllama(model="qwen2.5", base_url="http://192.168.69.221:11434/", context_window=4096)
    ...
    def create_documents(self, documents):
        """Update the vector store with new documents, clearing old ones."""
    ...
    def generate_threat_intelligence(self):
        ...
        for key, query in QUERIES.items():
            ...
            # Create and run chain for this intelligence type
            chain = (
                PROMPTS[key] 
                | self.llm 
                | StrOutputParser()
