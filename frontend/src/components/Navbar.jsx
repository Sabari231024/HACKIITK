...
import { Shield, LayoutDashboard, MessageSquare, AlertTriangle, LogOut } from 'lucide-react';
  ...
  return (
    <nav className="bg-gray-900 text-white h-screen w-64 fixed left-0 top-0 p-4">
      <div className="flex items-center gap-2 mb-8">
        ...
        <span className="text-xl font-bold">VULNEX</span>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Link to="/threat-extractor" className={`flex items-center gap-2 p-2 rounded hover:bg-blue-700 transition-colors ${isActive('/threat-extractor')}`}>
          <AlertTriangle className="w-5 h-5" />
          <span>Threat Extractor</span>
        </Link>
      </div>
